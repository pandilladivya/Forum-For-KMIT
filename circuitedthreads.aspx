<%@ Page Title="" Language="C#" MasterPageFile="~/forum.master" AutoEventWireup="true" CodeFile="circuitedthreads.aspx.cs" Inherits="circuitedthreads" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ThreadID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" AllowPaging="True">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="dati" HeaderText="Date" SortExpression="dati" />
        </Columns>
    ...
    <br />
    <br />
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FORUM1ConnectionString %>" SelectCommand="SELECT * FROM [CThread] where [ForumID]=@cforum and valid=1 ORDER BY [dati] DESC ">
        <SelectParameters>
