...
public partial class clubs : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
            ...
            cmd.CommandText = "INSERT INTO [dbo].[DForum]([titleID],[question],[postername],[dati]) VALUES(" + Convert.ToInt32(DropDownList1.Text) + ",'" + TextBox1.Text + "','" + Session["uname"].ToString() + "','" + time.ToString(format) + "')";
            conn.Open();
            cmd.ExecuteNonQuery();
            Label2.Visible = true;
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session["ForumID"] = GridView1.SelectedValue.ToString();
         ...
         Response.Redirect("clubsthreads.aspx");
