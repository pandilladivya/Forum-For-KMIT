<%@ Page Title="" Language="C#" MasterPageFile="~/forum.master" AutoEventWireup="true" CodeFile="circuited.aspx.cs" Inherits="circuited" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="container">  <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Narkisim" Font-Size="XX-Large" ForeColor="White" Text="Circuited"></asp:Label>
    <br />
    ...
    <br />
    <br />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="ForumID" AllowPaging="True">
     ...
     <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:FORUM1ConnectionString %>" SelectCommand="SELECT [ForumID],[question], [postername], [dati] FROM [CForum] where [titleID]=@titleID and [valid]=1 ORDER BY [dati] DESC">
        <SelectParameters>
    ...
    <br />
    <br />
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FORUM1ConnectionString %>" SelectCommand="SELECT * FROM [CTitle]"></asp:SqlDataSource>
