<%@ Page Title="" Language="C#" MasterPageFile="~/forum.master" AutoEventWireup="true" CodeFile="codefreaks.aspx.cs" Inherits="codefreaks" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Narkisim" Font-Size="XX-Large" ForeColor="White" Text="Code Freaks"></asp:Label>
    <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:FORUM1ConnectionString %>" SelectCommand="SELECT [ForumID],[question], [postername], [dati] FROM [BForum] where [titleID]=@titleID and [valid]=1  and valid=1 ORDER BY [dati] DESC">
        <SelectParameters>
    ...
    <br />
    <br />
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FORUM1ConnectionString %>" SelectCommand="SELECT * FROM [BTitle]"></asp:SqlDataSource>
