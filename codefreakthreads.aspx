<%@ Page Title="" Language="C#" MasterPageFile="~/forum.master" AutoEventWireup="true" CodeFile="codefreakthreads.aspx.cs" Inherits="codefreakthreads" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <br />
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FORUM1ConnectionString %>" SelectCommand="SELECT * FROM [BThread] where [ForumID]=@cforum and valid=1 ORDER BY [dati] DESC ">
        <SelectParameters>
